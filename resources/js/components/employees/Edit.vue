                ...
                <div class="card-body">
                    <form @submit.prevent="updateEmployee">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select v-model="form.country_id" @change="getStates()" class="form-control" name="country" aria-label="Default select example">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select v-model="form.state_id" @change="getCities()" class="form-control" name="state" aria-label="Default select example">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select v-model="form.department_id" class="form-control" name="department" aria-label="Default select example">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select v-model="form.city_id" class="form-control" name="city" aria-label="Default select example">
